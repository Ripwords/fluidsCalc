            ...
            <div id="container">
                ...
                <ion-list>
                    <ion-item>
                        ...
                        <ion-input v-if="!mFRShow" v-model="mFR" type="number" placeholder="Mass Flow Rate ( kg/s )"></ion-input>
                    ...
                    <ion-item>
                        ...
                        <ion-input v-if="!pumpShow" v-model="pump" type="number" placeholder="Pump Power ( kW )"></ion-input>
                        <ion-input v-else type="number" :value=pumpShow readonly></ion-input>

                        <ion-label>&#7814;<sub>t</sub> : </ion-label>
                        <ion-input v-if="!turbineShow" v-model="turbine" type="number" placeholder="Turbine Power ( kW )"></ion-input>
                        <ion-input v-else type="number" :value=turbineShow readonly></ion-input>
                    </ion-item>
                    <ion-item>
                        <ion-label>&Edot;<sub>L</sub> : </ion-label>
                        <ion-input v-if="!lossShow" v-model="loss" type="number" placeholder="loss ( kW )"></ion-input>
