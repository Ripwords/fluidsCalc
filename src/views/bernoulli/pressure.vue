<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            <Exit></Exit>
            <div id="container">
                <img class="invert" src="/img/bPressure.png" width="450" height="75">
                <br>
                <br>
                <ion-list>
                    <ion-item>
    ...
    computed: {
        p1Show() {
            if (this.p2 != "" && this.v1 != "" && this.v2 != "" && this.z1 != "" && this.z2 != "" && this.rho != "") {
                return parseFloat(this.rho * ((0.001*this.p2/this.rho) + (this.v2**2 / 2) + 9.81*(this.z2 - this.z1) - (this.v1**2 /2))/1000).toFixed(this.$store.state.decimal)
            } else {
                return ""
            }
        },
